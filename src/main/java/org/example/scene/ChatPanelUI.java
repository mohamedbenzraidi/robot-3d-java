...
public class ChatPanelUI {
    ...
    public ChatPanelUI(SimpleApplication app, SceneManager sceneManager) {
        this.app = app;
    ...
    public void show(String paintingContext) {
        ...
        if (chatBot == null) {
            String key = "AIzaSyB6bCBuh7PCK6OiHRX3sgv0tIdIOL_sQVA";
...
//                refreshChatDisplay();
        ...
        new Thread(() -> {
            try {
                String reply = chatBot.sendMessage(message, currentPaintingContext);
                ...
                app.enqueue(() -> {
                    ...
                    sceneManager.showRobotSpeech(reply);
                });
